...
(async function scrape() {
  ...
  try {
    await driver.get(
      "https://india.1xbet.com/line/cricket/2548980-vitality-blast/220691720-lancashire-lightning-nottinghamshire-outlaws"
    );
    ...
    const filePath = path.join(__dirname, "upcoming_detail.json");
